...
const PRODUCTS = {
  206: { name: "Plaid personnalisé — portrait d’animal", unitAmount: 3990, personalized: true, available: false },
  207: { name: "Bijou personnalisé — portrait d’animal", unitAmount: 2490, personalized: true, available: false },
  208: { name: "Brosse anti-poils 2-en-1 — vêtements & textiles", unitAmount: 2990, personalized: false, available: false }
};
